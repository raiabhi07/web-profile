export const project = [
  ...
  {
    name: "Weather-App",
    desc: "It is a react app which displays the current weather conditions, including temperature, humidity, wind speed, precipitation, and visibility. Users can get live weather data of different location. I have used the API from openweathermap to fetch the data.",
    skills: "ReactJs",
    link: "https://github.com/raiabhi07/Weather_App.git",
  },
  {
    name: "WeightConverter-App",
    desc: "It is a app which is used to convert weight of a person from Kg to Pounds and Ounces.",
    // skills: "ReactJs",
    link: "https://raiabhi07.github.io/WeightConverter_app/",
  },
];
